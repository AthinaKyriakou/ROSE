...
extensions = [
    ...
    Extension(
        name="cornac.models.emf.recom_emf",
        sources=["cornac/models/emf/recom_emf.pyx"],
        include_dirs=[np.get_include()],
        language="c++",
        extra_compile_args=compile_args,
        extra_link_args=link_args,
    ...
    Extension(
        name="cornac.models.nemf.recom_nemf",
        sources=["cornac/models/nemf/recom_nemf.pyx"],
        include_dirs=[np.get_include()],
        language="c++",
        extra_compile_args=compile_args,
        extra_link_args=link_args,
    ...
    Extension(
        name="cornac.metrics_explainer.mep.metric_exp_mep",
        sources=["cornac/metrics_explainer/mep/metric_exp_mep.pyx"],
        include_dirs=[np.get_include()],
        language="c++",
        extra_compile_args=compile_args,
        extra_link_args=link_args,
    ...
    Extension(
        name="cornac.metrics_explainer.endcg.metric_exp_endcg",
        sources=["cornac/metrics_explainer/endcg/metric_exp_endcg.pyx"],
        include_dirs=[np.get_include()],
        language="c++",
        extra_compile_args=compile_args,
        extra_link_args=link_args,
    ...
    Extension(
        name="cornac.metrics_explainer.div.metric_exp_div",
        sources=["cornac/metrics_explainer/div/metric_exp_div.pyx"],
        include_dirs=[np.get_include()],
        language="c++",
        extra_compile_args=compile_args,
        extra_link_args=link_args,
    ...
    Extension(
        name="cornac.metrics_explainer.fpr.metric_exp_fpr",
        sources=["cornac/metrics_explainer/fpr/metric_exp_fpr.pyx"],
        include_dirs=[np.get_include()],
        language="c++",
        extra_compile_args=compile_args,
        extra_link_args=link_args,
    ...
    Extension(
        name="cornac.metrics_explainer.fa.metric_exp_fa",
        sources=["cornac/metrics_explainer/fa/metric_exp_fa.pyx"],
        include_dirs=[np.get_include()],
        language="c++",
        extra_compile_args=compile_args,
        extra_link_args=link_args,
     ...
     Extension(
        name="cornac.metrics_explainer.ra.metric_exp_ra",
        sources=["cornac/metrics_explainer/ra/metric_exp_ra.pyx"],
        include_dirs=[np.get_include()],
        language="c++",
        extra_compile_args=compile_args,
        extra_link_args=link_args,
